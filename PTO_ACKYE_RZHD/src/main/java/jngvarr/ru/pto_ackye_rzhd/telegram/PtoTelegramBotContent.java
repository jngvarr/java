...
//            "Type /mydata to see data stored about yourself\n\n" +
    ...
    static final Map<TBot.ProcessState, Map<Integer, String>> mountedEquipmentDatum = Map.of(
            TBot.ProcessState.IIK_MOUNT, Map.of(
                    ...
                    1, "Введите номер концентратора, к которому привязан ИИК (если номер не известен - введите \"0\"): ",
                    2, "Введите наименование станции: ",
                    3, "Введите наименование подстанции: ",
