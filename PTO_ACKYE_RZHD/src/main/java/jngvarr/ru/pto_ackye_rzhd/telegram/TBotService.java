...
public class TBotService {
    ...
    void createMeteringPoint(Row otoRow, int deviceNumberColumnIndex, String[] dataParts) {
        createNewMeteringPointInDb(dataParts, otoRow);
        createNewMeteringPointInExcelFile(dataParts, otoRow, deviceNumberColumnIndex);
    }

    private void meterChangeInExcelFile(Row otoRow, int deviceNumberColumnIndex, String mountingMeterNumber) {
        Object mountingDeviceNumber = excelFileService.parseMeterNumber(mountingMeterNumber);
    ...
    private void meterChangeInDb(String deviceNumber, String mountingMeterNumber) {
        ...
        if (nm == null) {
            String[] nmData = getMeterData(mountingMeterNumber).orElseThrow(() ->
    ...
    private void createNewMeteringPointInExcelFile(String[] dataParts, Row otoRow, int deviceNumberColumnIndex) {
        ...
        Object mountingDeviceNumber = excelFileService.parseMeterNumber(mountingMeterNumber); //Номер счетчика
        if (mountingDeviceNumber instanceof Long) {
...
//        }
    ...
    private void createNewMeteringPointInDb(String[] dataParts, Row otoRow) {
        ...
        Meter newMeteringPointMeter = getOrCreateMeter(mountingMeterNumber, meterType, dataParts[0]);
    ...
    private String addOtoData(String deviceNumber, String logData, Row newLogRow, Row otoRow, int deviceNumberColumnIndex, boolean dataContainsNot123, int orderColumnNumber) {
        ...
        excelFileService.copyAndFillLogRow(otoRow, newLogRow, orderColumnNumber, taskOrder, columns);
    ...
    private String actionConfirmation(Long userId) {
        ...
        for (Map.Entry<String, String> entry : otoLog.entrySet()) {
            ...
            List<String> strings = stringsByActionType.get(actionType);
            ...
            switch (actionType) {
                ...
                default -> {
                    String device = TBot.ProcessState.IIK_WORKS.equals(processStates.get(userId)) ? " ПУ" : " Концентратор";
