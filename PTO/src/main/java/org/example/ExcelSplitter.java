...
public class ExcelSplitter { //разбиение сводных файлов на несколько в зависимости от наименования ЭЭЛ
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Путь к папке "свод"
        String inputFilePath = "d:\\YandexDisk\\ПТО РРЭ РЖД\\План ПТО\\";
...
//        String outputFolderPath = "d:\\Downloads\\пто\\план ПТО\\2025\\";
        String outputFolderPath = "d:\\YandexDisk\\ПТО РРЭ РЖД\\План ПТО\\";
    ...
    private static void splitExcelFile(File inputFilePath, String outputFolderPath) throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(inputFilePath);
            ...
            int eelColumnIndex = findColumnIndex(sheet, "ЭЭЛ", null);
            int regionColumnIndex = findColumnIndex(sheet, "Регион", null);
            if (regionColumnIndex == -1) {
                regionColumnIndex = findColumnIndex(sheet, "Субъект РФ", null);
            }
