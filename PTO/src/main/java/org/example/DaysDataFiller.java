...
//        String iikConsist = new File(folderPath + "Состав ИИК*").getName();

        try {

            Workbook planOTOWorkbook = new XSSFWorkbook(new FileInputStream(new File(planOTOFile)));
    ...
    String month = extractMonthFromFileName(today.toString());
